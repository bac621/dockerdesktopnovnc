...
RUN apt-get update -y && \
    apt-get install -y git net-tools x11vnc wget python python-numpy unzip xvfb firefox lxde menu mtr terminator iputils-ping geany htop tmux screen iperf netcat wireshark curl dnsutils snmp zenmap telnet filezilla && \
