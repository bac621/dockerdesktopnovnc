...
RUN apt-get update -y && \
    apt-get install -y git x11vnc wget python python-numpy unzip xvfb firefox lxde menu mtr terminator htop tmux screen iperf snmp zenmap telnet dnsutils filezilla && \
